                        ...
                        <table class="table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><div title="Vender"><a class="text-success" href="sell.php?id=<?php echo $dato->ID;?>"><i class="
                                    bi bi-cash-coin"></i></td>
                                    </div>
                                    <td><div title="Editar"><a class="text-info" href="update.php?id=<?php echo $dato->ID;?>"><i class="
                                    bi bi-pencil-fill"></a></i></td>
                                    </div>
                                    <td><div title="Eliminar"><a class="text-danger" href="delete.php?id=<?php echo $dato->ID;?>"><i class="
